...
in
  {
    imports = [ ./options.nix ./i3.nix ./dunst.nix ./polybar.nix ./rofi.nix ./alacritty.nix ./compton.nix ];
    ...
    home.packages = with pkgs; [
      ...
      # DEVELOPMENT
      postman
      default-python gcc gnumake go nodejs nixpkgs-fmt
      # OFFICE
      zathura 
      # DEFAULT
      ...
      neovim = {
        ...
        ''
          ...
          plugins = with pkgs.vimPlugins; [
            ...
            fzf-vim fzfWrapper
            ale
            coc-nvim coc-go coc-json coc-html coc-yaml coc-python
          ];
        }; 
        bat = {
          enable = true;
