  ...
  xsession = {
    ...
    windowManager.xmonad = {
      ...
      config = pkgs.writeText "xmonad.hs" ''
        ...
        --
        myNormalBorderColor  = "#${colors.base02}"
        myFocusedBorderColor = "#${colors.base08}"
        ...
        myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
            ...
            -- launch rofi
            , ((modm, xK_d), spawn "rofi -show drun -modi drun -show-icons -matching fuzzy")
            ...
            --, ((modm,               xK_Return), windows W.swapMaster) -- overwritten with terminal
