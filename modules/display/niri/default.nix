  ...
  flake.modules.homeManager.niri = { config, pkgs, ... }:
    let
      ...
      colors = {
        ...
        inactive = palette.base06;
        accent = palette.base0E;
        accentAlt = palette.base0B;
        urgent = palette.base04;
        success = palette.base0C;
      ...
      niriConfig = ''
                ...
                window-rule {
                    match app-id=r#"^Emacs$"# title="^org-capture$"
                    open-floating true
                    // Anchor to the top edge of the screen.
                    default-floating-position x=0 y=30 relative-to="top"
