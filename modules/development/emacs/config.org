...
* Config
steal stuff from [[https://github.com/mclear-tools/dotemacs/blob/master/cpm-setup-meow.el][here]] for meow
** Initial Setup
#+begin_src elisp
;; -*- lexical-binding: t -*-
...
** Font
#+begin_src elisp
(setq myfont "Mononoki Nerd Font Mono-18")
...
#+end_src
*** Diminish
Slim line the modeline displays "lighters" for minor modes.
#+begin_src elisp
