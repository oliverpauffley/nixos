  ...
  (use-package org
    ...
    (setq org-default-notes-file "~/org/todo.org"
          ...
          org-agenda-files (list
                            "~/org/todo.org"
                            "~/org/work/todo.org"
                            ;; not including this currently"~/org/programming/todo.org"
                            ;;"~/org/rpgs/todo.org"
                            "~/org/contacts.org.gpg")
          calendar-date-style 'european
          org-todo-keywords '((sequence "TRIAGE(e)" "BACKLOG(b)" "READY-FOR-REFINEMENT(i)" "REFINED(r)" "TODO(t)" "IN-PROGRESS(p)" "REVIEW(w)" "|" "DONE(d!)" "CANCELED(c)"))
...
(use-package consult-gh
  ...
  :bind (:map my-git-keymap ("r" . #'my/get-current-repo-run-list))
  )
